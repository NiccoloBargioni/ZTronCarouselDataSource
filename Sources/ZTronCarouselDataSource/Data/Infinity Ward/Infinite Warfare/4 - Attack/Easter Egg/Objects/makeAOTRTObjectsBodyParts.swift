...
public func makeAOTRTObjectsBodyParts() -> SerializableGalleryNode {
        ...
        SerializableImageNode(
            ...
            overlays: [
                ...
                SerializableOutlineNode(
                    resourceName: "iw.aotrt.easter.egg.objects.body.parts.1.arm.beach.front.of.the.radioactive.thing.outline",
                    boundingBox: .init(
                        x: 942.0 / 1920.0,
                        y: 555.0 / 1080.0,
                        width: 11.0 / 1920.0,
    ...
    bodyPartsLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.aotrt.easter.egg.objects.body.parts.2.arm.inside.embers.in.the.campers.area.outline",
                    boundingBox: .init(
                        x: 1430.0 / 1920.0,
                        y: 761.0 / 1080.0,
                        width: 193.0 / 1920.0,
    ...
    // 4 - FRIDGE POWER OUTSIDE GAS STATION OFFSETS: 394, 658 | LARGHEZZA: 151, ALTEZZA: 62
    ...
    bodyPartsLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.aotrt.easter.egg.objects.body.parts.5.body.pork.meat.inside.beachside.market.outline",
                    boundingBox: .init(
                        x: 1594.0 / 1920.0,
                        y: 327.0 / 1080.0,
                        width: 125.0 / 1920.0,
    ...
    bodyPartsLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.aotrt.easter.egg.objects.body.parts.6.leg.wherever.you.melee.first.radioactive.zombie.outline",
                    boundingBox: .init(
                        x: 726.0 / 1920.0,
                        y: 705.0 / 1080.0,
                        width: 67.0 / 1920.0,
    ...
    bodyPartsLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.aotrt.easter.egg.objects.body.parts.7.head.in.the.pack.a.punch.alt.room.outline",
                    boundingBox: .init(
                        x: 872.0 / 1920.0,
                        y: 519.0 / 1080.0,
                        width: 24.0 / 1920.0,
