        ...
        SerializableImageNode(
            ...
            overlays: [
                ...
                SerializableOutlineNode(
                    resourceName: "iw.ss.skullbreaker.mahjong.1.disco.inferno.rooftop.outline",
                    boundingBox: .init(
                        x: 1336.0 / 2715.0,
                        y: 691.0 / 1527.0,
                        width: 12.0 / 2715.0,
    ...
    tilesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ss.skullbreaker.mahjong.4.column.front.of.disco.inferno.sign.outline",
                    boundingBox: .init(
                        x: 1136.0 / 2715.0,
                        y: 643.0 / 1527.0,
                        width: 38.0 / 2715.0,
    ...
    tilesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ss.skullbreaker.mahjong.5.blue.bolts.wood.box.outline",
                    boundingBox: .init(
                        x: 1463.0 / 2715.0,
                        y: 725.0 / 1527.0,
                        width: 10.0 / 2715.0,
    ...
    tilesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ss.skullbreaker.mahjong.8.heebie.geebies.top.of.box.back.room.outline",
                    boundingBox: .init(
                        x: 1073.0 / 2715.0,
                        y: 790.0 / 1527.0,
                        width: 34.0 / 2715.0,
    ...
    tilesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ss.skullbreaker.mahjong.9.dojo.rooftop.racing.stripes.red.box.outline",
                    boundingBox: .init(
                        x: 1038.0 / 1920.0,
                        y: 540.0 / 1080.0,
                        width: 7.0 / 1920.0,
    ...
    tilesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ss.skullbreaker.mahjong.10.disco.inferno.entrance.from.lion.outline",
                    boundingBox: .init(
                        x: 1013.0 / 1920.0,
                        y: 554.0 / 1080.0,
                        width: 19.0 / 1920.0,
