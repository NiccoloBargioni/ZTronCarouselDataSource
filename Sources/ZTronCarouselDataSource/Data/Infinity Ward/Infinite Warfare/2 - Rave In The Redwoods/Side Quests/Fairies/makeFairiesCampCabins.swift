        ...
        SerializableImageNode(
            ...
            overlays: [
                ...
                SerializableOutlineNode(
                    resourceName: "iw.ritr.side.quests.fairies.camp.cabins.1.intersection.between.camp.owl.and.camp.wolf.outline",
                    boundingBox: .init(
                        x: 544.0 / 1920.0,
                        y: 441.0 / 1080.0,
                        width: 122.0 / 1920.0,
    ...
    fairiesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ritr.side.quests.fairies.camp.cabins.2.end.of.camp.owl.outline",
                    boundingBox: .init(
                        x: 992.0 / 1920.0,
                        y: 511.0 / 1080.0,
                        width: 41.0 / 1920.0,
    ...
    fairiesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ritr.side.quests.fairies.camp.cabins.3.front.of.magic.wheel.outline",
                    boundingBox: .init(
                        x: 940.0 / 1920.0,
                        y: 459.0 / 1080.0,
                        width: 116.0 / 1920.0,
    ...
    fairiesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ritr.side.quests.fairies.camp.cabins.4.behind.magic.wheel.outline",
                    boundingBox: .init(
                        x: 663.0 / 1920.0,
                        y: 439.0 / 1080.0,
                        width: 143.0 / 1920.0,
    ...
    fairiesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ritr.side.quests.fairies.camp.cabins.5.big.fire.front.of.camp.wolf.sign.outline",
                    boundingBox: .init(
                        x: 784.0 / 1920.0,
                        y: 422.0 / 1080.0,
                        width: 227.0 / 1920.0,
    ...
    fairiesLocations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "iw.ritr.side.quests.fairies.camp.cabins.6.camp.wolf.sign.from.mess.hall.outline",
                    boundingBox: .init(
                        x: 811.0 / 1920.0,
                        y: 464.0 / 1080.0,
                        width: 57.0 / 1920.0,
