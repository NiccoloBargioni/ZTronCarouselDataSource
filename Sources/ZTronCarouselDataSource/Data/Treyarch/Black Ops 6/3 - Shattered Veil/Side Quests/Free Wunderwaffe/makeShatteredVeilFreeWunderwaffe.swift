...
public func makeShatteredVeilFreeWunderwaffe() -> SerializableGalleryRouter {
    ...
    freeWunderwaffeLocations.register(
        SerializableImageNode(
            name: "bo6.sv.side.quests.free.wunderwaffe.microwave.trex.room",
            description: "bo6.sv.side.quests.free.wunderwaffe.microwave.trex.room.caption",
            position: 7,
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.sv.side.quests.free.wunderwaffe.microwave.trex.room.outline",
                    boundingBox: .init(
                        x: 1687.0 / 3840.0,
                        y: 1000.0 / 2160.0,
                        width: 58.0 / 3840.0,
    ...
    ), at: ["bo6.sv.side.quests.free.wunderwaffe.microwave.trex.room"])

    
    freeWunderwaffeLocations.register(
        SerializableImageNode(
            name: "bo6.sv.side.quests.free.wunderwaffe.final.positioning.spot",
            description: "bo6.sv.side.quests.free.wunderwaffe.final.positioning.spot.caption",
            position: 8,
    ), at: ["bo6.sv.side.quests.free.wunderwaffe.final.positioning.spot"])
