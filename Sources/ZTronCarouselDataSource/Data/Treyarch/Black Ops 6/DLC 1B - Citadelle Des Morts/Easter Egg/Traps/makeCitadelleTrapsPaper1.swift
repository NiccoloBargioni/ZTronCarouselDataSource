        ...
        SerializableImageNode(
            ...
            overlays: [
                ...
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.first.paper.1.location.1.outline",
                    boundingBox: .init(
                        x: 3398.0 / 3840.0,
                        y: 1021.0 / 2160.0,
                        width: 325.0 / 3840.0,
    ...
    paper1Locations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.first.paper.2.location.2.outline",
                    boundingBox: .init(
                        x: 3165.0 / 3840.0,
                        y: 985.0 / 2160.0,
                        width: 136.0 / 3840.0,
    ...
    paper1Locations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.first.paper.3.location.3.outline",
                    boundingBox: .init(
                        x: 3222.0 / 3840.0,
                        y: 901.0 / 2160.0,
                        width: 107.0 / 3840.0,
