        ...
        SerializableImageNode(
            ...
            overlays: [
                ...
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.third.paper.1.location.1.outline",
                    boundingBox: .init(
                        x: 703.0 / 3840.0,
                        y: 928.0 / 2160.0,
                        width: 204.0 / 3840.0,
    ...
    paper3Locations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.third.paper.2.location.2.outline",
                    boundingBox: .init(
                        x: 3075.0 / 3840.0,
                        y: 765.0 / 2160.0,
                        width: 282.0 / 3840.0,
    ...
    paper3Locations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.third.paper.3.location.3.outline",
                    boundingBox: .init(
                        x: 2614.0 / 3840.0,
                        y: 894.0 / 2160.0,
                        width: 101.0 / 3840.0,
