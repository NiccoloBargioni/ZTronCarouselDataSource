        ...
        SerializableImageNode(
            ...
            overlays: [
                ...
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.fourth.paper.1.location.1.outline",
                    boundingBox: .init(
                        x: 3150.0 / 3840.0,
                        y: 912.0 / 2160.0,
                        width: 112.0 / 3840.0,
    ...
    paper4Locations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.fourth.paper.2.location.2.outline",
                    boundingBox: .init(
                        x: 2694.0 / 3840.0,
                        y: 838.0 / 2160.0,
                        width: 51.0 / 3840.0,
    ...
    paper4Locations.register(
        SerializableImageNode(
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo6.cdm.easter.egg.traps.fourth.paper.3.location.3.outline",
                    boundingBox: .init(
                        x: 574.0 / 3840.0,
                        y: 1011.0 / 2160.0,
                        width: 200.0 / 3840.0,
