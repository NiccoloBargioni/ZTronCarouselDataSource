...
func makeKeeperProtectorDerEisendrache() -> SerializableGalleryNode {
    ...
    return SerializableGalleryNode(
        name: "bo3.revelations.easter.egg.keeper.protector.der.eisendrache",
        position: 0,
        assetsImageName: "bo3.revelations.easter.egg.keeper.protector.der.eisendrache.icon",
