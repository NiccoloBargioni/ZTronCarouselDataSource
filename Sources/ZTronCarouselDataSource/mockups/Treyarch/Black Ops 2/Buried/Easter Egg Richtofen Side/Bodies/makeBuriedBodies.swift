...
public func makeBuriedBodies() -> SerializableGalleryRouter {
    ...
    buriedRoundInfinityLocations.register(
        SerializableImageNode(
            name: "bo2.buried.easter.egg.richtofen.bodies.12.arthurs.cell",
            ...
            overlays: [
                SerializableBoundingCircleNode(),
                SerializableOutlineNode(
                    resourceName: "bo2.buried.easter.egg.richtofen.bodies.12.arthurs.cell.outline",
                    boundingBox: .init(
                        x: 1047.0 / 1920.0,
                        y: 451.0 / 1080.0,
                        width: 129.0 / 1920.0,
    ...
    ), at: ["bo2.buried.easter.egg.richtofen.bodies.12.arthurs.cell"])
    ...
    buriedRoundInfinityLocations.register(
        ...
        at: ["bo2.buried.easter.egg.richtofen.bodies.12.arthurs.cell", "round infinity"],
        withParameter: defaultParam
    )
