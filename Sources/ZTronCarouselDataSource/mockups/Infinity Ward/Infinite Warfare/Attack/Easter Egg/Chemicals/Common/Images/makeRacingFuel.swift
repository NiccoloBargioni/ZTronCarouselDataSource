...
func makeRacingFuel(forPosition: Int) -> SerializableImageNode {
    ...
    return SerializableImageNode(
        name: "iw.aotrt.ee.chemicals.gas.station.outside.chemicals.lab.racing.fuel",
        description: "iw.aotrt.ee.chemicals.gas.station.outside.chemicals.lab.racing.fuel.caption",
        position: forPosition,
        overlays: [
            SerializableBoundingCircleNode(),
            SerializableOutlineNode(
                resourceName: "iw.aotrt.ee.chemicals.gas.station.outside.chemicals.lab.racing.fuel.outline",
                boundingBox: .init(
                    x: 818.0/2715.0,
                    y: 723.0/1527.0,
                    width: 21.0/2715.0,
