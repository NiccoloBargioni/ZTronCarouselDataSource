...
let package = Package(
    ...
    dependencies: [
        ...
        .package(
            url: "https://github.com/NiccoloBargioni/ZTronDataModel", branch: "development/testing"
        ),
        .package(
            url: "https://github.com/NiccoloBargioni/ZTronSerializable", branch: "development/updateToolsPositions"
        ),
        .package(
